...
#        inv_sq = (1.0/sqrt(2.0))
        ...
        # w(t), sigma_t^2
        #w = (1 - self.alphas[t])
        w = 1 #self.alphas[t] ** 0.5 * (1 - self.alphas[t])
        grad = w * (noise_pred - noise)

#        print('np',noise_pred.abs().mean(dim=(2,3)))
#        print('n',noise.abs().mean(dim=(2,3)))
#        print('l',latents.abs().mean(dim=(2,3)))

#        print('g',grad.abs().mean(dim=(2,3)))
...
#        loss = SpecifyGradient.apply(latents, grad) 
        loss = torch.ones([1], device=latents.device, dtype=latents.dtype)
        return loss 
